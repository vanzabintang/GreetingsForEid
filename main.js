...
function initengahan(){
  ...
  function kethalo(){
  new TypeIt("#halo", {
  strings: ["" + vketikhalo], startDelay: 30, speed: 30, waitUntilVisible: true,
  ...
  async function menuju(){pesanwhatsapp = "*" + nama + "*" + " dan keluarga + mengucapkan Minal Aidzin Mohon Maaf Lahir Dan Batin ><";await swals.fire('OK!', 'Kirim pesan ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send?phone=&text=" + pesanwhatsapp;}
